...
const translations = {
  de: {
    ...
    back: "Zurück",
    holidays: "Feiertage",
    germany_holidays_school: "Feiertage / Schulferien Deutschland",
    german_holidays_sub: "Deutsche Feiertage",
    school_holidays_sub: "Schulferien",
    show_winter_holidays: "Winterferien anzeigen",
    show_easter_holidays: "Osterferien anzeigen",
    show_pentecost_holidays: "Pfingstferien anzeigen",
    show_summer_holidays: "Sommerferien anzeigen",
    show_autumn_holidays: "Herbstferien anzeigen",
    show_christmas_holidays: "Weihnachtsferien anzeigen",
    region: "Region",
    ...
    font_size_popup: "Schriftgröße im Popup",
    week_starts_on: "Woche beginnt am",
    show_week_numbers: "Wochenzahlen anzeigen",
    ...
    shift: "Schicht",
    vacation: "Urlaub",
    show_vacation_countdown: "Urlaub-Countdown anzeigen",
    vacation_countdown_mode: "• Urlaub-Countdown Modus",
    vacation_mode_queue: "Warteschlange",
    vacation_mode_all: "Alle anzeigen",
    show_birthday_countdown: "Geburtstag-Countdown anzeigen",
    show_event_info_box: "Ereignisse-Box anzeigen",
    event_info_title: "Ereignisse",
    event_info_empty: "Keine Termine / Geburtstage",
    consider_public_holidays: "Feiertage berücksichtigen (Urlaub)",
    vacation_shift_default: "Urlaub Standard Schicht-Einstellung",
    ...
    year: "Jahr",
    color: "Farbe",
    shift_setting: "Schicht-Einstellung",
    shift_setting_default: "Standard",
    shift_setting_1shift_no_weekends: "Wochenenden abziehen",
    without_weekend_short: "Ohne WE",
    with_weekend_short: "mit WE",
    notes: "Notizen",
  ...
  en: {
    ...
    back: "Back",
    holidays: "Holidays",
    germany_holidays_school: "Germany holidays / school holidays",
    german_holidays_sub: "German public holidays",
    school_holidays_sub: "School holidays",
    show_winter_holidays: "Show winter holidays",
    show_easter_holidays: "Show Easter holidays",
    show_pentecost_holidays: "Show Pentecost holidays",
    show_summer_holidays: "Show summer holidays",
    show_autumn_holidays: "Show autumn holidays",
    show_christmas_holidays: "Show Christmas holidays",
    region: "Region",
    ...
    display: "Display",
    font_size: "Font size",
    font_size_popup: "Popup font size",
    ...
    shift: "Shift",
    vacation: "Vacation",
    show_vacation_countdown: "Show vacation countdown",
    vacation_countdown_mode: "• Vacation countdown mode",
    vacation_mode_queue: "Queue",
    vacation_mode_all: "Show all",
    show_birthday_countdown: "Show birthday countdown",
    show_event_info_box: "Show events box",
    event_info_title: "Events",
    event_info_empty: "No appointments / birthdays",
    consider_public_holidays: "Consider public holidays (vacation)",
    vacation_shift_default: "Vacation default shift setting",
    ...
    shift_setting_default: "Default",
    shift_setting_1shift_no_weekends: "Subtract weekends",
    without_weekend_short: "Without WE",
    with_weekend_short: "with WE",
    notes: "Notes",
  ...
  tr: {
    ...
    germany_holidays_school: "Almanya tatilleri / okul tatilleri",
    german_holidays_sub: "Almanya resmî tatilleri",
    school_holidays_sub: "Okul tatilleri",
    show_winter_holidays: "Kış tatilini göster",
    show_easter_holidays: "Paskalya tatilini göster",
    show_pentecost_holidays: "Pentekost tatilini göster",
    show_summer_holidays: "Yaz tatilini göster",
    show_autumn_holidays: "Sonbahar tatilini göster",
    show_christmas_holidays: "Noel tatilini göster",
    region: "Bölge",
    ...
    font_size_popup: "Açılır pencere yazı boyutu",
    ...
    settings: "Ayarlar",
    events: "Etkinlikler",
    entries_label: "Kayıtlar",
    appointment: "Randevu",
    birthday: "Doğum günü",
    birthday_suffix: "doğum günü",
    shift: "Vardiya",
    vacation: "İzin",
    show_vacation_countdown: "İzin geri sayımını göster",
    vacation_countdown_mode: "• İzin geri sayım modu",
    vacation_mode_queue: "Kuyruk",
    vacation_mode_all: "Hepsini göster",
    show_birthday_countdown: "Doğum günü geri sayımını göster",
    show_event_info_box: "Etkinlik kutusunu göster",
    event_info_title: "Etkinlikler",
    event_info_empty: "Randevu / doğum günü yok",
    consider_public_holidays: "Resmi tatilleri dikkate al (izin)",
    vacation_shift_default: "İzin varsayılan vardiya ayarı",
    ...
    year: "Yıl",
    color: "Renk",
    shift_setting: "Vardiya ayarı",
    shift_setting_default: "Standart",
    shift_setting_1shift_no_weekends: "Hafta sonlarını düş",
    without_weekend_short: "HS hariç",
    with_weekend_short: "HS dahil",
    notes: "Notlar",
  ...
  fr: {
    ...
    germany_holidays_school: "Allemagne : jours fériés / vacances scolaires",
    german_holidays_sub: "Jours fériés allemands",
    school_holidays_sub: "Vacances scolaires",
    show_winter_holidays: "Afficher les vacances d’hiver",
    show_easter_holidays: "Afficher les vacances de Pâques",
    show_pentecost_holidays: "Afficher les vacances de Pentecôte",
    show_summer_holidays: "Afficher les vacances d’été",
    show_autumn_holidays: "Afficher les vacances d’automne",
    show_christmas_holidays: "Afficher les vacances de Noël",
    region: "Région",
    ...
    font_size_popup: "Taille de police de la fenêtre",
    ...
    shift: "Équipe",
    vacation: "Vacances",
    show_vacation_countdown: "Afficher le compte à rebours des vacances",
    vacation_countdown_mode: "• Mode du compte à rebours des vacances",
    vacation_mode_queue: "File d’attente",
    vacation_mode_all: "Tout afficher",
    show_birthday_countdown: "Afficher le compte à rebours des anniversaires",
    show_event_info_box: "Afficher la boîte d’événements",
    event_info_title: "Événements",
    event_info_empty: "Aucun rendez-vous / anniversaire",
    consider_public_holidays: "Prendre en compte les jours fériés (congés)",
    vacation_shift_default: "Réglage d’équipe par défaut pour les vacances",
    ...
    year: "Année",
    color: "Couleur",
    shift_setting: "Paramètre d’équipe",
    shift_setting_default: "Standard",
    shift_setting_1shift_no_weekends: "Exclure les week-ends",
    without_weekend_short: "Sans WE",
    with_weekend_short: "avec WE",
    notes: "Notes",
  ...
  ar: {
    ...
    back: "رجوع",
    holidays: "العطل",
    germany_holidays_school: "العطل / العطل المدرسية في ألمانيا",
    german_holidays_sub: "العطل الألمانية",
    school_holidays_sub: "العطل المدرسية",
    show_winter_holidays: "إظهار عطلة الشتاء",
    show_easter_holidays: "إظهار عطلة الربيع",
    show_pentecost_holidays: "إظهار عطلة العنصرة",
    show_summer_holidays: "إظهار عطلة الصيف",
    show_autumn_holidays: "إظهار عطلة الخريف",
    show_christmas_holidays: "إظهار عطلة عيد الميلاد",
    region: "المنطقة",
    ...
    display: "العرض",
    font_size: "حجم الخط",
    font_size_popup: "حجم خط النافذة المنبثقة",
    week_starts_on: "بداية الأسبوع",
    show_week_numbers: "إظهار أرقام الأسابيع",
    ...
    settings: "الإعدادات",
    events: "الأحداث",
    entries_label: "الإدخالات",
    appointment: "موعد",
    birthday: "عيد ميلاد",
    birthday_suffix: "عيد ميلاد",
    shift: "وردية",
    vacation: "إجازة",
    show_vacation_countdown: "إظهار العد التنازلي للإجازة",
    vacation_countdown_mode: "• وضع العد التنازلي للإجازة",
    vacation_mode_queue: "قائمة انتظار",
    vacation_mode_all: "عرض الكل",
    show_birthday_countdown: "إظهار العد التنازلي لعيد الميلاد",
    show_event_info_box: "عرض مربع الأحداث",
    event_info_title: "الأحداث",
    event_info_empty: "لا توجد مواعيد / أعياد ميلاد",
    consider_public_holidays: "مراعاة العطل الرسمية (الإجازة)",
    vacation_shift_default: "إعداد الوردية الافتراضي للإجازة",
    ...
    year: "السنة",
    color: "اللون",
    shift_setting: "إعداد الوردية",
    shift_setting_default: "افتراضي",
    shift_setting_1shift_no_weekends: "استبعاد عطلة نهاية الأسبوع",
    without_weekend_short: "بدون عطلة أسبوعية",
    with_weekend_short: "مع عطلة أسبوعية",
    notes: "ملاحظات",
